...
function showMainMenu() {
	...
	editLinks = document.getElementsByClassName("MenuCopiers");
	for(var i = 0; i < editLinks.length; i++) editLinks[i].style.display = "none";
	editLinks = document.getElementsByClassName("MenuViewers");
	for(var i = 0; i < editLinks.length; i++) editLinks[i].style.display = "none";
	editLinks = document.getElementsByClassName("MenuSorters");
	for(var i = 0; i < editLinks.length; i++) editLinks[i].style.display = "none";
	editLinks = document.getElementsByClassName("MenuFilters");
	for(var i = 0; i < editLinks.length; i++) editLinks[i].style.display = "none";
	editLinks = document.getElementsByClassName("MenuPickers");
	for(var i = 0; i < editLinks.length; i++) editLinks[i].style.display = "none";
	removeTools();
}
...
function showCopiersMenu() {
	...
	var editLinks = document.getElementsByClassName("MenuCopiers");
	for(var i = 0; i < editLinks.length; i++) 
	{	
		if(editLinks[i].tagName == "BR") editLinks[i].style.display = "inline";
		else editLinks[i].style.display = "block";
...
function showViewersMenu() {
	...
	var editLinks = document.getElementsByClassName("MenuViewers");
	for(var i = 0; i < editLinks.length; i++) 
	{	
		if(editLinks[i].tagName == "BR") editLinks[i].style.display = "inline";
		else editLinks[i].style.display = "block";
...
function showSortersMenu() {
	...
	var editLinks = document.getElementsByClassName("MenuSorters");
	for(var i = 0; i < editLinks.length; i++) 
	{	
		if(editLinks[i].tagName == "BR") editLinks[i].style.display = "inline";
		else editLinks[i].style.display = "block";
...
function showFiltersMenu() {
	...
	var editLinks = document.getElementsByClassName("MenuFilters");
	for(var i = 0; i < editLinks.length; i++) 
	{	
		if(editLinks[i].tagName == "BR") editLinks[i].style.display = "inline";
		else editLinks[i].style.display = "block";
...
function showPickersMenu() {
	...
	var editLinks = document.getElementsByClassName("MenuPickers");
	for(var i = 0; i < editLinks.length; i++) 
	{	
		if(editLinks[i].tagName == "BR") editLinks[i].style.display = "inline";
		else editLinks[i].style.display = "block";
...
async function fetchJson(mode) {
	...
	if(mode === "public")
	{
		if(fetchLocal) json = JSON_PAYLOAD;
		else
		{
