...
<body style="height:100%;">
	...
	<!-- Add Edit Info Modal aka 'makeEditModal' -->
					...
					<form id="editForm" style='display: flex; flex-direction: column; width:100%; height:100%;'>
						...
						<div id="summary-div" style='margin-top: 0px; width:100%; min-height:60px; background-color: #fff; padding-top: 0px; padding-bottom: 0px; border: 2px white;'>
							...
							<div id="BottomToolbar" colspan="10" style="text-align: center; padding: 10px; background-color: #fff;">
								...
								<img src="img/eye-closed-thin.png" style="border: 1px solid black; border-radius: 40px; background-color: #ccc; padding:4px; height: 30px; width: 30px; cursor: pointer; margin: 7px;" onclick='openMakeEditModal();' />
	...
	<script>
		function openMakeEditModal() { document.getElementById('makeEditModal').style.display = "block"; }
		function closeMakeEditModal() { document.getElementById('makeEditModal').style.display = "none"; }
	</script>
