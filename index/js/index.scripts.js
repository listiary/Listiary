...
function cleanPage() {						// remove all content from containers
	...
	var smallTopContainer = document.getElementById("SmallTopContainer");
	if(smallTopContainer != null) smallTopContainer.innerHTML = "";
	...
	if(smallContainer != null) smallContainer.innerHTML = "";
...
function personalClick(username) {			// Navbar->Personal click
	...
	else 
	{
		...
		//alert("Not logged in");
		window.location.href = "https://development.worldinlists.net/session/login.php" + param;
	}
}
...
media = getMedia();
if(media == "mobile" || media == "small") showMobile();
